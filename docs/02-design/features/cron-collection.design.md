...
<!-- 2026-03-26: 서비스 전수검사 보안 수정 -->
<!-- - creative-saliency, analyze-lp-saliency, video-saliency: CRON_SECRET 인증 추가 (인증 없이 외부 호출 가능했던 취약점) -->
<!-- - precompute, analyze-competitors, competitor-check: 조건부 인증(cronSecret &&) → 강제 인증(!authHeader ||)으로 변경 -->
