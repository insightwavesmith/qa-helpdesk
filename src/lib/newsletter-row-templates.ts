  ...
  columns: [{
    ...
    contents: [{
      ...
      values: {
        ...
        selectable: true, draggable: true, duplicatable: true, deletable: true, hideable: true,
        text: '<table width="100%" cellpadding="0" cellspacing="0" style="margin:24px 0;"><tr><td style="padding:24px 0;border-top:1px solid #e2e8f0;border-bottom:1px solid #e2e8f0;"><table cellpadding="0" cellspacing="0"><tr><td width="100" style="vertical-align:top;"><img src="https://bscamp.app/images/meta-partner/profile-smith.png" alt="스미스" style="width:80px;height:80px;border-radius:50%;display:block;" /></td><td style="vertical-align:top;"><p style="margin:0;font-weight:800;font-size:16px;color:#1a1a1a;">스미스 <span style="font-weight:600;font-size:13px;color:#F75D5D;">자사몰사관학교 코치</span></p><p style="margin:6px 0 0;font-size:13px;color:#64748b;line-height:160%;">Meta Business Partner로서 광고 성과를 높입니다<br>수강생 자사몰매출 450억+</p></td></tr></table><div style="margin-top:16px;padding-top:16px;border-top:1px solid #f1f5f9;"><img src="https://bscamp.app/images/meta-partner/inline-positive.png" alt="Meta Business Partners" style="height:36px;display:block;" /></div></td></tr></table>',
      },
    }],
    values: {
      backgroundColor: "", padding: "0px", border: {}, borderRadius: "0px",
