...
function AdminEmailPageInner() {
  ...
  const [linkedContentTitle, setLinkedContentTitle] = useState<string | null>(null);
  ...
  useEffect(() => {
    ...
    getContentAsEmailHtml(contentIdParam).then((result) => {
      if (result.data) {
        ...
        setLinkedContentTitle(result.data.subject);
            ...
            <div className="space-y-3">
              ...
              <AiWriteDialog
                ...
                onGenerated={(result) => {
                  ...
                  toast.success("AI 최신정보가 생성되었습니다.");
                }}
              />
              <ContentPickerDialog
