...
| 항목 | 값 |
|------|-----|
| 마지막 완료 TASK | 체크리스트 82/84 완료 (98%) |
| 전체 Match Rate | 98% (84항목 중 82 완료, 2 BLOCKED) |
| 남은 항목 | 2건 — 비회원 ad_accounts(DB구조) + M4 Max(HW) |
...
| # | 항목 | 사유 | 해소 방법 |
|---|------|------|----------|
| 1 | 비회원 ad_accounts (ch2) | ad_accounts.user_id NOT NULL + RLS | DB 스키마 변경 + Meta BM 토큰 |
| 2 | M4 Max 로컬 (ch1) | HW 전환 | Railway+Vercel 정상 가동 중 |
